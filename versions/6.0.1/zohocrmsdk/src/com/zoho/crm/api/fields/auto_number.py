...
class AutoNumber(object):
	def __init__(self):
		...
		self.__starting_number_length = None
		self.__prefix = None
		self.__suffix = None
		self.__start_number = None
		self.__key_modified = dict()

	def get_starting_number_length(self):
		"""
		...
		return self.__starting_number_length

	def set_starting_number_length(self, starting_number_length):
		"""
		The method to set the value to starting_number_length

		Parameters:
			starting_number_length (int) : An int representing the starting_number_length
		"""

		if starting_number_length is not None and not isinstance(starting_number_length, int):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: starting_number_length EXPECTED TYPE: int', None, None)
		
		self.__starting_number_length = starting_number_length
		self.__key_modified['starting_number_length'] = 1
