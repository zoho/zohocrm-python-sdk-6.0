...
class User(MinifiedUser):
	...
	def get_zuid(self):
		...
		Returns:
			int: An int representing the zuid
		"""
	...
	def set_zuid(self, zuid):
		...
		Parameters:
			zuid (int) : An int representing the zuid
		"""

		if zuid is not None and not isinstance(zuid, int):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: zuid EXPECTED TYPE: int', None, None)
