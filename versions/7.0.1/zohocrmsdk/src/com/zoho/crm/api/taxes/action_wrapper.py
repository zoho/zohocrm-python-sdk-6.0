...
class ActionWrapper(ActionHandler):
	...
	def set_org_taxes(self, org_taxes):
		...
		Parameters:
			org_taxes (ActionResponse) : An instance of ActionResponse
		"""
		...
		if org_taxes is not None and not isinstance(org_taxes, ActionResponse):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: org_taxes EXPECTED TYPE: ActionResponse', None, None)
