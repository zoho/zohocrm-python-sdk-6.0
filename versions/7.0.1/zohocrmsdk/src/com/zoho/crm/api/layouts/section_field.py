...
class SectionField(Fields):
	...
	def get_auto_number_69(self):
		...
		return self.__auto_number_69

	def set_auto_number_69(self, auto_number_69):
		"""
		The method to set the value to auto_number_69

		Parameters:
			auto_number_69 (AutoNumber) : An instance of AutoNumber
		"""
		...
		if auto_number_69 is not None and not isinstance(auto_number_69, AutoNumber):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: auto_number_69 EXPECTED TYPE: AutoNumber', None, None)
		
		self.__auto_number_69 = auto_number_69
