...
class Notification(Event):
	...
	def set_deleteevents(self, deleteevents):
		...
		Parameters:
			deleteevents (Choice) : An instance of Choice
		"""

		if deleteevents is not None and not isinstance(deleteevents, Choice):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: deleteevents EXPECTED TYPE: Choice', None, None)
