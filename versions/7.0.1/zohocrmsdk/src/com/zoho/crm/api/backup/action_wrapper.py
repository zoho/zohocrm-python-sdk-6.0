...
class ActionWrapper(ActionHandler):
	...
	def set_backup(self, backup):
		...
		Parameters:
			backup (ActionResponse) : An instance of ActionResponse
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.backup.action_response import ActionResponse
		except Exception:
			from .action_response import ActionResponse

		if backup is not None and not isinstance(backup, ActionResponse):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: backup EXPECTED TYPE: ActionResponse', None, None)
