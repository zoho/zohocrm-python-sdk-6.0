...
class ActionWrapper(object):
	...
	def set_hipaa_compliance(self, hipaa_compliance):
		...
		Parameters:
			hipaa_compliance (ActionResponse) : An instance of ActionResponse
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.hipaa_compliance.action_response import ActionResponse
		except Exception:
			from .action_response import ActionResponse

		if hipaa_compliance is not None and not isinstance(hipaa_compliance, ActionResponse):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: hipaa_compliance EXPECTED TYPE: ActionResponse', None, None)
