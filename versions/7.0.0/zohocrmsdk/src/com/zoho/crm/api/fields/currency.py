...
class Currency(object):
	...
	def set_rounding_option(self, rounding_option):
		...
		Parameters:
			rounding_option (Choice) : An instance of Choice
		"""

		if rounding_option is not None and not isinstance(rounding_option, Choice):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: rounding_option EXPECTED TYPE: Choice', None, None)
