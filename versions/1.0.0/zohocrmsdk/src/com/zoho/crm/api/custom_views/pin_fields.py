...
class PinFields(object):
	...
	def get_pin(self):
		...
		Returns:
			bool: A bool representing the pin
		"""
	...
	def set_pin(self, pin):
		...
		Parameters:
			pin (bool) : A bool representing the pin
		"""

		if pin is not None and not isinstance(pin, bool):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: pin EXPECTED TYPE: bool', None, None)
		
		self.__pin = pin
		self.__key_modified['_pin'] = 1
