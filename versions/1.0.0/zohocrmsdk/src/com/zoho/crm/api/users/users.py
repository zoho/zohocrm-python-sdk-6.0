...
class Users(Record):
	...
	def get_phone(self):
		...
		Returns:
			int: An int representing the phone
		"""
	...
	def set_phone(self, phone):
		...
		Parameters:
			phone (int) : An int representing the phone
		"""

		if phone is not None and not isinstance(phone, int):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: phone EXPECTED TYPE: int', None, None)
	...
	def set_time_zone(self, time_zone):
		...
		if time_zone is not None and not isinstance(time_zone, TimeZone):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: time_zone EXPECTED TYPE: TimeZone', None, None)
	...
	def get_mobile(self):
		...
		Returns:
			int: An int representing the mobile
		"""
	...
	def set_mobile(self, mobile):
		...
		Parameters:
			mobile (int) : An int representing the mobile
		"""

		if mobile is not None and not isinstance(mobile, int):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: mobile EXPECTED TYPE: int', None, None)
