...
class Info(object):
	...
	def get_default(self):
		...
		Returns:
			int: An int representing the default
		"""
	...
	def set_default(self, default):
		...
		Parameters:
			default (int) : An int representing the default
		"""

		if default is not None and not isinstance(default, int):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: default EXPECTED TYPE: int', None, None)
	...
	def set_translation(self, translation):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.custom_views.translation import Translation
		except Exception:
