...
class Fields(object):
	...
	def get_auto_number_60(self):
		...
		return self.__auto_number_60

	def set_auto_number_60(self, auto_number_60):
		"""
		The method to set the value to auto_number_60

		Parameters:
			auto_number_60 (AutoNumber) : An instance of AutoNumber
		"""
		...
		if auto_number_60 is not None and not isinstance(auto_number_60, AutoNumber):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: auto_number_60 EXPECTED TYPE: AutoNumber', None, None)
		
		self.__auto_number_60 = auto_number_60
