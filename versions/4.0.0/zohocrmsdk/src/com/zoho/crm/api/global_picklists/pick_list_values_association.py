...
class PickListValuesAssociation(object):
	def __init__(self):
	...
	def set_resources(self, resources):
		...
		Parameters:
			resources (list) : An instance of list
		"""

		if resources is not None and not isinstance(resources, list):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: resources EXPECTED TYPE: list', None, None)
		
		self.__resources = resources
		self.__key_modified['resources'] = 1
