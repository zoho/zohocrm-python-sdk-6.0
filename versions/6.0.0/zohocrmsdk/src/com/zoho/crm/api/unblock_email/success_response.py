try:
	...
	from zohocrmsdk.src.com.zoho.crm.api.unblock_email.action_response import ActionResponse
except Exception:
...
class SuccessResponse(ActionResponse):
	...
	def get_code(self):
		...
		Returns:
			string: A string representing the code
		"""
	...
	def set_code(self, code):
		...
		if code is not None and not isinstance(code, str):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: code EXPECTED TYPE: str', None, None)
