...
class EmailTemplate(InventoryTemplates, Template):
	...
	def set_folder(self, folder):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.inventorytemplates import Folder
		except Exception:
	...
	def set_module(self, module):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.inventorytemplates import ModuleMap
		except Exception:
	...
	def set_created_by(self, created_by):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.inventorytemplates import User
		except Exception:
